...
class EDagGenerator:
    ...
    def generate(self) -> EDag:
        ...
        # curr_vertex: Dict[int, Dict[str, int]] = defaultdict(dict)
        curr_vertex: Dict[str, int] = {}
        ...
        for line in trace:
            ...
            if new_vertex.target is not None:
                curr_vertex[new_vertex.target] = new_vertex.id
            
            if new_vertex.sec_target is not None:
                curr_vertex[new_vertex.sec_target] = new_vertex.id
